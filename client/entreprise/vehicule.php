...
<body style="background-color:gray;height:100%;overflow:hidden;padding-top:15px;">
    <div class="container" style="background-color:white; width:70%;border-radius:10px; height:92vh;">
        <div class="center" style="background-color:white;">
            ...
            <form class="form" style="padding-top:15px;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="immat" class="form-control" style="margin-right:20px;transition:.3s;"><br><br>
