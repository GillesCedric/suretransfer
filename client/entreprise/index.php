			...
			<div class="panel-body">
				<form method="get" action="" class="form-inline">
					<div class="form-group">
						...
						<input type="text" name="" placeholder="Taper un montant" id="" class="form-control" value="<?php /*echo $mc;*/ ?>" />
					...
					<ul class="nav nav-pills nav-right">
						<li>
							<form class="form-inline">
								...
								<input type="hidden" name="" value="<?php //echo $idc 
																										?>">
								<input type="hidden" name="motCle" value="<?php //echo $mc 
																													?>">
								<input type="hidden" name="page" value="<?php //echo $page 
																												?>">
								<select name="size" class="form-control" onchange="this.form.submit()">
									<option <?php //if($size==10) echo "selected" 
													?>>10</option>
									<option <?php //if($size==15) echo "selected" 
													?>>15</option>
									<option <?php //if($size==20) echo "selected" 
													?>>20</option>
									<option <?php //if($size==25) echo "selected" 
													?>>25</option>
								</select>
							</form>
						</li>
